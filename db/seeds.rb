...
categories = [
  ...
  { name_ru: "Общество", name_en: "Society" }
]
...
ru_news = [
  ...
  { title: "Экономика США 'Завязла в грязи'", slug: "usa-economy-stuck-in-the-mud", category: "Экономика", tag_list: "США", url: "http://img.youtube.com/vi/7nsDDe16FdY/0.jpg", online: true, content: "<p> Экономика США является одной из наиболее диверсифицированных национальных экономик мира и удерживавшая лидерство в мировой экономике последние 100 лет. Однако с начала 2000-х годов в следствии кризисов и роста развивающихся стран, её влияние в мировой экономике не много снизилась.</p> <p style='text-align: center;'> <iframe allowfullscreen='' frameborder='0' height='315' src='http://www.youtube.com/embed/7nsDDe16FdY' width='560'></iframe></p>" },
  { title: "Квачков приговорен к 13 годам тюрьмы", slug: "kvachkov-sentenced", category: "Общество", tag_list: "приговор, Квачков", url: "http://static2.aif.ru/public/news/big/816/5b3f3d12929302cc489a93c7f175fa3a.0.jpg", content: "Бывшего офицера ГРУ признали виновным в подготовке переворота. Мосгорсуд приговорил бывшего полковника ГРУ Владимира Квачкова к 13 годам лишения свободы за подготовку военного мятежа.", published_by: "Аргументы и Факты", p_url: "http://www.aif.ru" },
  { title: "Международная конференция о месте нотариата в правовой системе", slug: "conference-notaries", category: "Политика", tag_list: "конференция, нотариат", announcement: true, content: "В понедельник, 11 февраля, в 10.00 в международном мультимедийном пресс-центре РИА Новости пройдет международная конференция \"Нотариат России: защита собственника — опыт двадцати лет\". 11 февраля 1993 г. Верховным Советом РФ были приняты Основы законодательства РФ о нотариате. Какое место занимает нотариат в современной российской правовой системе? Какова его роль в реформе гражданского законодательства?" }
]
...
ru_news.each do |news|
  ...
  news[:online] ||= false
  news[:published_by] ||= ""
  news[:announcement] ||= false

  News.create! category_id: category.id, title: news[:title], award_id: a.id,
    content: news[:content], remote_logo_url: news[:url], slug: news[:slug],
    tag_list: news[:tag_list], online: news[:online], publish_url: news[:p_url],
    published_by: news[:published_by], announcement: news[:announcement]
end
...
statics = [
  { name: 'Ratings', content: "<p>Таким образом, ФедБренд - это единая площадка для оценки, анализа, обсуждения и обучения тонкостям региональной информационной политики для развития Субъектов Федерации.</p><h2>Политика</h2><p>«Федеральный бренд» (ФедБренд)  - репутационный рейтинг регионов, основанный на постоянном мониторинге медиапространства РФ и экспертных оценках  PR-профилей субъектов Федерации. Цель проекта «ФедБренд»  - популяризировать тему управления репутацией для успешной жизнедеятельности регионов.</p><h2>Преимущества рейтинга &laquo;Федеральный бренд&raquo;</h2><ul><li>Масштабный периодический рейтинг, построенный на собственной авторской  методике.</li><li>Выход на новый уровень в вопросе  управления репутацией. С помощью ведущих специалистов в вопросах PR мы надеемся привлечь руководителей госслужбы на местах к этому обсуждению и заинтересовать региональные власти всерьез относиться к информационной политике своего региона и использовать разные инструменты (а не только заказные статьи и сюжеты, как это принято сейчас).</li><li>Международное сотрудничество. Благодаря ряду экспертов из стран Европы (Германия, Франция)  Японии и США, мы наглядно покажем, что репутация региона - это не только внутри федеральный, показатель, но и очень важный признак для успешной международной работы.</li></ul>" },
  { name: 'Ratings_side_block', content: "<h2>О методике рейтинга</h2><p>В рейтинге &laquo;Федеральный бренд&raquo; (Федбренд) участвуют все регионы Российской Федерации. Москва и Санкт-Петербург находятся в рейтинге на особом положении (так как обладают рядом особенностей и отличаются от основной массы регионов). По уникальной авторской методике мы подсчитываем репутационный индекс региона, в основе которого несколько показателей.</p><p>Первый, количественный &ndash; выводится из числа профильных публикаций на федеральном и региональном уровнях, а также &ndash; их тональности. Качественный показатель - то совокупность экспертных оценок. В число экспертов рейтинга входят аналитики, известные экономисты, политологи, ведущие журналисты, а также руководители, ответственные за привлечение инвестиций в регионы, сенаторы и депутаты.</p><article><header><span class='get-bradius'>1</span></header><h3>Количество публикаций в федеральных и региональных СМИ с разделением по тональности (позитивные и негативные) &ndash; количественный показатель.</h3><p>На протяжении месяца осуществляется мониторинг ключевых региональных событий. В качестве выбранных для анализа выступают публикации с упоминанием каждого из регионов по ключевым словам, характеризующим репутационную привлекательность региона.</p></article>" },
  { name: 'Awards_index', content: "<h3>Это награда за выдающиеся результаты, достигнутые в области территориального маркетинга:</h3><p>Cоздания социокультурных, спортивных либо иных проектов, которые повышают инвестиционную привлекательность региона. Создание и развитие геобрендов, проектов, улучшающих уровень жизни населения региона и повышающих имидж конкретной территории, что в свою очередь автоматически относится к репутационным технологиям. Премия присуждается на конкурсной основе и сопровождается вручением наград и дипломов.</p>" },
  { name: 'Awards_organizers', content: "<p><b>Организатор.&nbsp;</b>Cоздания социокультурных, спортивных либо иных проектов, которые повышают инвестиционную привлекательность региона. Создание и развитие геобрендов. создания социокультурных, спортивных либо иных проектов, которые повышают инвестиционную привлекательность региона. Создание и развитие геобрендов.</p>" }
]

statics.each do |static|
  Static.create! name: static[:name], content_ru: static[:content]
end
